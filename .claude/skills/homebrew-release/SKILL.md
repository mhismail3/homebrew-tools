...
git tag -a v{version} -m "{tool-name} v{version}"
...
```bash
# Download the auto-generated tarball from GitHub
curl -L https://github.com/mhismail3/homebrew-tools/archive/refs/tags/v{version}.tar.gz -o v{version}.tar.gz
...
```
{64-character-hex-hash}  v{version}.tar.gz
```
...
```ruby
# OLD
url "https://github.com/mhismail3/homebrew-tools/archive/refs/tags/v{old-version}.tar.gz"
sha256 "{old-sha256}"

# NEW
url "https://github.com/mhismail3/homebrew-tools/archive/refs/tags/v{new-version}.tar.gz"
sha256 "{new-sha256}"
```
...
2. **Create tag:**
   ```bash
   git tag -a v0.1.1 -m "mistral-ocr v0.1.1"
...
4. **Get SHA256:**
   ```bash
   curl -L https://github.com/mhismail3/homebrew-tools/archive/refs/tags/v0.1.1.tar.gz -o v0.1.1.tar.gz
...
5. **Update formula:**
   ...
   url "https://github.com/mhismail3/homebrew-tools/archive/refs/tags/v0.1.1.tar.gz"
